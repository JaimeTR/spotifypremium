[PSCustomObject]@{
    ...
    Welcome         = "
╔════════════════════════════╗
║ Witamy w SpotifyPremium dla Windows ║
╚════════════════════════════╝"
    ...
    Spicetify       = "Wykryto Spicetify. Należy zainstalować je po SpotifyPremium. Czy otworzyć zalecane działania w FAQ? [Y/N]"
    NoRestore       = "SpotifyPremium został już pobrany, lecz xpui.bak nie został znaleziony. `nProszę odinstalować klienta Spotify i uruchomić Install.bat ponownie"
