[PSCustomObject]@{
    ...
    Welcome         = "
╔════════════════════════════════════╗
║ Καλώς ήρθατε στο SpotifyPremium για Windows ║
╚════════════════════════════════════╝"
    ...
    NoRestore       = "Το SpotifyPremium έχει ήδη εγκατασταθεί, το xpui.bak δεν βρέθηκε. `nΠαρακαλώ απεγκαταστήστε το πρόγραμμα Spotify και εκτελέστε ξανά το Install.bat"
